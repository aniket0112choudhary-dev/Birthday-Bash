    ...
    <section className="relative min-h-[calc(100vh-64px)] py-24">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center animate-fade-up">
        ...
        <div className="mx-auto mt-12 max-w-2xl space-y-6 text-lg leading-relaxed text-foreground/80">
          ...
          <p>
            You have always been the quiet strength behind every happy moment in my life.
            Your love feels like warm sunlight after a long day, comforting and constant
            in ways words can never fully explain. The care in your voice, the patience
            in your hands, and the way you always put everyone before yourself make our
            home feel complete. Even in difficult times, you stand like a calm light
            guiding our family forward. I may not say it every day, but your love is the
            reason so many of my smiles exist. Thank you for being my safe place, my
            support, and the heart of our family.
          </p>
