...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A heartfelt birthday celebration for the woman who taught us love. Memories, wishes, and AI-crafted notes — all for Mom." },
      { property: "og:title", content: "Happy Birthday, Mom — A Letter in Bloom" },
      { property: "og:description", content: "A heartfelt birthday celebration for the woman who taught us love." },
